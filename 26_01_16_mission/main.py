...
class MyHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        <body>
            ...
            <br>
            <h2>출처</h2>
            <p>이미지 출처: https://pals.tistory.com/2523</p>
            <p>내용 출처: https://ko.wikipedia.org/wiki/%EB%A7%A4%EC%8A%AC%EB%A1%9C%EC%9D%98_%EC%9A%95%EA%B5%AC%EB%8B%A8%EA%B3%84%EC%9D%B4%EB%A1%A0</p>
        </body>
        </html>
        """
