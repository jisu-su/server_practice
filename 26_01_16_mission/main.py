    ...
    def do_GET(self):
        ...
        <body>
            ...
            <ul>
                ...
                <li>인간의 욕구를 생리적 욕구, 안전 욕구, 소속감과 사랑 욕구, 존중 욕구, 자아실현 욕구의 5단계 피라미드로 설명하며, 하위 욕구가 충족되어야 상위 욕구를 추구하게 되는 동기 부여 원리이다.
            </ul>
            <br>
            ...
            <p> 개인의 생리적 욕구가 충족되면, 다음으로 안전의 용구가 우선하여 행동에 큰 영향을 미친다. 신체적 안전이 결여된 상황이나 경제적 안전이 결여된 상황에서 나타난다.</p>
            <ul>
                <li>건강
                <li>개인적 안전
                <li>정서적 안전
